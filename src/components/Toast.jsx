  ...
  return (
    ...
    >
        <div className={`flex items-center p-4 rounded-3xl shadow-2xl bg-carbon-900 border ${borderColorClass} backdrop-blur-xl text-gray-200`}>
            ...
            <button 
                onClick={onClose} 
                className="ml-auto -mx-1.5 -my-1.5 p-2 rounded-2xl inline-flex items-center justify-center h-8 w-8 text-gray-400 hover:text-white hover:bg-carbon-800 transition cursor-pointer"
                aria-label="Fechar"
            >
